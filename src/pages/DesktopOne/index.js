  ...
  return (
    <>
      <Column className="bg-white_A700 flex flex-col font-inter items-center justify-start mx-[auto] md:p-[137px] sm:p-[15px] p-[200px] w-[100%]">
        <Column className="bg-blue_200 flex flex-col items-center justify-start max-w-[420px] sm:mb-[198px] md:mb-[256px] mb-[373px] ml-[auto] mr-[auto] sm:p-[15px] md:p-[24px] p-[36px] sm:pl-[15px] sm:pr-[15px] rounded-radius25 shadow-bs w-[100%]">
          <Input
          ...
          ></Input>
          <Button
            className="common-pointer cursor-pointer font-bold sm:mb-[17px] md:mb-[22px] mb-[33px] min-w-[36%] sm:mt-[15px] md:mt-[19px] mt-[29px] text-[20px] text-black_900 text-center w-[max-content]"
            onClick={() => {
